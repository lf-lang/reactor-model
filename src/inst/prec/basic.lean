...
namespace precedence.graph
  ...
  def edges_are_well_formed_over (ρ : precedence.graph υ) (η : inst.network.graph υ) : Prop :=
  ...
  def ids_are_well_formed_over (ρ : precedence.graph υ) (η : inst.network.graph υ) : Prop :=
  ...
  def data_is_well_formed_over (ρ : precedence.graph υ) (η : inst.network.graph υ) : Prop :=
    ∀ i, ρ.rcn i = η.rcn i

  def is_well_formed_over (ρ : precedence.graph υ) (η : inst.network.graph υ) : Prop :=
    ρ.ids_are_well_formed_over   η ∧ 
    ρ.data_is_well_formed_over   η ∧ 
    ρ.edges_are_well_formed_over η 

  lemma indep_rcns_neq_rtrs {η : inst.network.graph υ} {ρ : precedence.graph υ} (h : ρ.is_well_formed_over η) {i i' : reaction.id} :
  ...
  lemma indep_rcns_not_ext_dep {η : inst.network.graph υ} {ρ : precedence.graph υ} (h : ρ.is_well_formed_over η) {i i' : reaction.id} :
